...
const News = (props) => {
  ...
  return (
    <>
      <h2 className="animate__animated animate__backInDown text-center" style={{margin: '35px 0px', marginTop: '30px', backgroundColor: "lightgreen"}}>Top HeadLines on {capitalizeFirstLetter(props.category)}</h2>
      <InfiniteScroll
